...
export default function ResumeList() {
  ...
  const [migrateTarget, setMigrateTarget] = useState<ResumeListItem | null>(null)
  ...
  const handleMigrate = useCallback((resume: ResumeListItem) => {
    setMigrateTarget(resume)
  }, [])
